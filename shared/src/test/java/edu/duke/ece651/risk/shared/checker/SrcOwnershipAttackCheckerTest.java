...
class SrcOwnershipAttackCheckerTest {
    ...
    public void test_checkMyRule(){
        ...
        ActionChecker checker = new SrcOwnershipAttackChecker(null);

        // success
        AttackOrder attackOrder = new AttackOrder(0L, "Test1", "Test2", "Soldier", 10);
        assertNull(checker.checkMyRule(riskMap, attackOrder));

        // error: place from a foreign territory
        AttackOrder attackOrder2 = new AttackOrder(0L, "Test2", "Test1", "Soldier", 10);
        assertEquals("You must place attack orders from your own territories!", checker.checkMyRule(riskMap, attackOrder2));
    }
