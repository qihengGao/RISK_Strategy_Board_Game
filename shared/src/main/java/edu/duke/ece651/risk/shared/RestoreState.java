...
public class RestoreState extends State{
    ...
    public void doAction(ClientContext contex) throws IOException, ClassNotFoundException {
        ...
        if(command.equals("")){
            ...
            System.out.println("\"Sending restore id: "+oriClientID);
        ...
        contex.setPlayerID(riskGameMessage.getClientid());
        contex.setGameState(contex.getGameState());
        contex.setRiskMap(riskGameMessage.getRiskMap());
        contex.setIdToColor(riskGameMessage.getIdToColor());
